      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm font-medium">
            {loading ? null : user ? (
              <Link href="/dashboard" className="bg-[#0055ff] hover:bg-[#0044cc] text-white px-5 py-2 rounded-full transition-all flex items-center gap-1 shadow-sm shadow-blue-500/20">
                Go to Dashboard
              </Link>
            ) : (
              <>
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 space-y-8 z-10 w-full max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            {loading ? null : user ? (
              <Link href="/dashboard" className="inline-flex justify-center items-center gap-2 bg-[#0055ff] hover:bg-[#0044cc] text-white px-8 py-3.5 rounded-full font-medium text-lg transition-all shadow-md shadow-blue-500/20">
                Go to Dashboard
              </Link>
            ) : (
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto bg-[#0055ff] rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-blue-500/20">
          ...
          <div className="relative z-10 space-y-8 flex flex-col items-center">
            ...
            {loading ? null : user ? (
              <Link href="/dashboard" className="inline-flex justify-center items-center bg-white hover:bg-slate-50 text-[#0055ff] px-10 py-4 rounded-full font-bold text-xl transition-all shadow-xl hover:scale-105 active:scale-95 border border-white/50">
                Go to Dashboard
              </Link>
            ) : (
